...
class _MainState extends State<MainScreen> {
  ...
  List<Song> songList = [
      Song(title: "Emergence", artist: "Sleep Token", duration: "6:47", url: "Sleep_Token_Emergence.mp3"),
      Song(title: "Super Mario Bros Theme", artist: "Nintendo", duration: "3:05", url: "Super_Mario_Bros_Theme_Song.mp3"),
    ];
